...
class ShardedGradScaler(TorchGradScaler):
    ...
    def _foreach_non_finite_check_and_unscale_cpu_(
        ...
        for tensor in grads:
            ...
            # as remarked here https://github.com/pytorch/pytorch/blob/master/aten/src/ATen/native/cuda/AmpKernels.cu#L108 # noqa
    ...
    def _unscale_grads_(  # type: ignore
        ...
        per_device_and_dtype_grads = defaultdict(lambda: defaultdict(list))  # type: ignore[var-annotated] # noqa
        with torch.no_grad():
    ...
    def update(self, new_scale: Optional[Union[float, FloatTensor]] = None) -> None:
        ...
        if new_scale is not None:
            ...
            if isinstance(new_scale, float):
                ...
                assert isinstance(new_scale, torch.cuda.FloatTensor), reason  # type: ignore[attr-defined] # noqa
