...
from llm.models.mg_models.llama.word_embedings import EmbeddingPipe
from llm.models.mg_models.base_modules.lora.layers import LoraVocabParallelEmbedding
...
class EmbedddingPipeNoTied(EmbeddingPipe):
    ...
    def forward(self, inputs, **kwargs):
        lm_output, loss_mask, labels, cu_seqlens = inputs[0], inputs[1], inputs[2], inputs[3]
        if isinstance(self.word_embeddings, LoraVocabParallelEmbedding):
            ...
            return lora_parallel_lm_logits(
                ...
                sequence_parallel=self.sequence_parallel), loss_mask, labels, cu_seqlens
        else:
