...
from llm.models.mg_models.base_modules.modules.enums import AttnMaskType, AttnType, PositionEmbeddingType
...
from llm.models.mg_models.base_modules.utils import (attention_mask_func,
                                                     openai_gelu,
                                                     erf_gelu,
...
from llm.models.mg_models.base_modules.layers.glu_activations import GLU_ACTIVATIONS
...
class ParallelTransformerLayerPipe(ParallelTransformerLayer):
    ...
    def forward(self, inputs, **kwargs):
        ...
        if torch.is_tensor(inputs) or len(inputs) == 1:
            ...
            hidden_states, loss_mask, labels = inputs[0], inputs[1], inputs[2]
            attention_mask = None
            return super().forward(hidden_states, attention_mask, **kwargs), loss_mask, labels
        elif len(inputs) == 4:
            ...
            hidden_states, cu_seqlens, position_ids, loss_mask, labels = inputs[0], inputs[1], inputs[2], inputs[3], inputs[4]
            attention_mask = None
            return super().forward(hidden_states, attention_mask, cu_seqlens, position_ids, **kwargs), cu_seqlens, position_ids, loss_mask, labels
        else:
